                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="{{ route('dashboard') }}" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <h2 class="mt-4 bg-dark text-white">Smart Shop</h2>
                            </span>
                        </a>
                    </div>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('customers.index') }}">
                                <i class="bx bx-store"></i>
                                <span key="t-ecommerce">Add Customer</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('suppliers.index') }}">
                                <i class="bx bx-store"></i>
                                <span key="t-ecommerce">Add Supplier</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('orders.index') }}">
                                <i class="bx bx-store"></i>
                                <span key="t-ecommerce">Add Order</span>
                            </a>
                        </li>
                    </ul>
                </div>
